...
def renameall():
    ...
    fileList = os.listdir(r"D:\domain\try\trainB")  # 待修改文件夹
    print("修改前："+str(fileList))     #输出文件夹中包含的文件
    currentpath = os.getcwd()       #得到进程当前工作目录
    os.chdir(r"D:\domain\try\trainB")        #将当前工作目录修改为待修改文件夹的位置
    num=1       #名称变量
    for fileName in fileList:       #遍历文件夹中所有文件
        ...
        if fileNamea[1]=="jpg" :
            if num> 1 :
                ...
                # newnamea = newnamea[0] + "_" + newnamea[1] + "_" + newnamea[2]  +"_"+newnamea[3]+ ".png"
